...
class TestGetLang:
    ...
    def test_returns_original_when_no_override(self, converter):
        with patch.object(converter, "get_installed_languages", return_value=["eng", "deu"]):
    ...
    def test_returns_override_when_installed(self, converter):
        ...
        with patch.object(converter, "get_installed_languages", return_value=["fra"]):
    ...
    def test_falls_back_to_original_when_override_not_installed(self, converter):
        converter.diff_langs = {"deu": "fra"}
        with patch.object(converter, "get_installed_languages", return_value=["deu"]):
